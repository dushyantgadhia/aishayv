...
export class BlockComponent<Props, S, SS> extends Component<Props, S, SS>
  ...
  public parseApiErrorResponse(responseJson: any) {
    console.log('EARC->parseApiErrorResponse', responseJson);
    if (!responseJson || responseJson.success) {
      return;
    }
    const errors: any[] = responseJson.message || responseJson.errors || responseJson.error;
    console.log('EARC->parseApiErrorResponse->errors', errors);
