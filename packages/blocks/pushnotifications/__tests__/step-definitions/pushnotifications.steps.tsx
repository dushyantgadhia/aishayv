...
const feature = loadFeature('./__tests__/features/pushnotifications-scenario.feature');
...
defineFeature(feature, (test) => {
    ...
    test('User navigates to pushnotifications', ({ given, when, then }) => {
        ...
        given('I am a User loading pushnotifications', () => {
            exampleBlockA = shallow(<Pushnotifications {...screenProps}/>)
        });

        when('I navigate to the pushnotifications', () => {
             instance = exampleBlockA.instance() as Pushnotifications
        });
